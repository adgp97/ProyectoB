...
**     Date/Time   : 2019-06-22, 12:44, # CodeGen: 0
**     Abstract    :
**         Main module.
...
void main(void)
{
  /* Write your local variable definition here */
	...
	char aux1, aux2, x1[11], x2[11], trama[3], offset1 = 0, offset2 = 0;
	char signed k;		
	/*
  ...
  for(;;){ 			
    	if(ch_flg == 1){
			...
			//	PTD4_SetVal();			//Just for testing purposes.
			...
			//	PTD4_ClrVal();			//Just for testing purposes.  			
		...
		//ch_flg = !ch_flg;		//Set to sample the other channel
	}
